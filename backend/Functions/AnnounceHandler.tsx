...
const AnnounceHandler = async (announcementType: announceType, torrent: iTorrent, client: iClient) : Promise<boolean> => {
...
export const announceLoop = (torrents: iTorrent[], clients: iClient[]) => {
    ...
    return {torrentTasksToAnnounce, announcedTorrentsToSave, torrentQueueToSave};
};
